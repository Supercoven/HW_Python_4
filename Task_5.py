...
def main():
    poly1 = readFromFile("poly.txt")
    print("Многочлен 1:", poly1)
    poly2 = readFromFile("poly_2.txt")
    print("Многочлен 2:", poly2)

    print("Многочлен 1, преобразованный в список:", parse_poly(poly1))
    print("Многочлен 2, преобразованный в список:", parse_poly(poly2))
